...
The good news is that most of them are based around `NSFastEnumeration` `for in` loop and quite straight forward to implement if want to. Just, please, don't forget to prefix it with your branded `xyz_`.
